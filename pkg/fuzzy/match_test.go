...
func TestMatch(t *testing.T) {
	table := []struct {
		...
		{"gosextant", "go/src/github.com/khoiracle/sextant", true},
		{"Gosextant", "go/src/github.com/khoiracle/sextant", false},
		{"srghub", "go/src/github.com/khoiracle/sextant", true},
		{"hubgit", "go/src/github.com/khoiracle/sextant", false},
